      ...
      {selectedPatient && (
        <div className="mt-4">
          ...
          <div className="mt-4 flex gap-2">
            <button className="bg-blue-500 text-white px-4 py-2 rounded" onClick={() => console.log('Edit Checkup')}>Edit Checkup</button>
            <button className="bg-red-500 text-white px-4 py-2 rounded" onClick={() => console.log('Delete Checkup')}>Delete Checkup</button>
          </div>

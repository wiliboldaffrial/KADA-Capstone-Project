...
const SharedPatientListLayout = ({ title, patients: patientData }) => {
...
const PatientList = () => {
    ...
    if (role === 'nurse') {
        return <SharedPatientListLayout title="Patient List (Nurse View)" patients={patients} />;
    }
    
    if (role === 'doctor') {
        // Now uses the same layout component, just with a different title
        return <SharedPatientListLayout title="Patient List (Doctor View)" patients={patients} />;
    }
